...
def calc_loss_slope(cir,output_conditions,loss_dict,optimization_input_parameters,run_number):
    ...
    for param_name in optimization_input_parameters['optimization'][run_number]['optimizing_parameters']:
        ...
        if optimization_input_parameters['optimization']['optimization_name']=='loss1':
            loss_dict1=lf.calc_loss(extracted_parameters1,output_conditions,loss_weights)
        #elif optimization_input_parameters['optimization']['optimization_name']=='fom1':
...
def opt_single_run(cir,optimization_input_parameters,run_number):
    ...
    # Calculating loss
    if optimization_input_parameters['optimization']['optimization_name']=='loss1':
        loss_iter[-1]=lf.calc_loss(cir.extracted_parameters,output_conditions,loss_weights)
    #elif optimization_input_parameters['optimization']['optimization_name']=='fom1':
    ...
    while i<max_iteration:
        ...
        if optimization_input_parameters['optimization']['optimization_name']=='loss1':
            check_loss=lf.calc_check_loss(loss_iter,i,loss_type)
        #elif optimization_input_parameters['optimization']['optimization_name']=='fom1':
        ...
        if optimization_input_parameters['optimization']['optimization_name']=='loss1':
            lf.update_circuit_parameters(cir,circuit_parameters_slope,check_loss,optimization_input_parameters,run_number)
        #lif optimization_input_parameters['optimization']['optimization_name']=='fom1':
        ...
        if optimization_input_parameters['optimization']['optimization_name']=='loss1':
            loss_iter[i]=lf.calc_loss(cir.extracted_parameters,output_conditions,loss_weights)
        #elif optimization_input_parameters['optimization']['optimization_name']=='fom1':
